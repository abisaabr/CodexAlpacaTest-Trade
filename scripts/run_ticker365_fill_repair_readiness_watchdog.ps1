...
$LogPath = Join-Path $LogDir "ticker365_fill_repair_readiness_watchdog.log"
...
$GcsPrefix = "gs://codexalpaca-control-us/research_results/ticker365_fill_repair_20260503T1330Z"
$OutputDir = "reports/gcp_research/ticker365_fill_repair_paper_readiness_20260503"
...
Add-WatchdogLogLine "===== ticker365_fill_repair_readiness_watchdog run $stamp ====="
