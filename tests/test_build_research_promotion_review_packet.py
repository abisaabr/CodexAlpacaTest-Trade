...
def test_promotion_review_packet_marks_eligible_research_candidates(
    ...
    assert "informational only" in packet["next_actions"][1]
...
def test_promotion_review_packet_preserves_regime_representatives_not_in_top_slice(
    tmp_path: Path,
) -> None:
    report_path = tmp_path / "research_portfolio_report.json"
    _write_report(
        report_path,
        {
            "promotion_allowed": True,
            "candidate_count": 100,
            "eligible_for_promotion_review_count": 3,
            "fill_coverage_gate": 0.90,
            "min_option_trades": 20,
            "min_test_net_pnl": 0,
            "capital_plan_allocated_weight": 0.35,
            "capital_plan_unallocated_weight": 0.65,
            "capital_plan_unallocated_dollars": 16_250.0,
            "required_regimes": ["bull", "bear", "choppy"],
            "eligible_regimes": ["bull", "bear", "choppy"],
            "missing_eligible_regimes": [],
            "regime_complete_for_promotion_review": True,
            "promotion_allowed_regime_complete": True,
            "capital_plan": [],
            "eligible_regime_representatives": [
                {
                    "candidate_variant_id": "bull_rep",
                    "base_candidate_variant_id": "bull_base",
                    "candidate_identity_mode": "variant_profile",
                    "aggregate_profile": "profile_bull",
                    "symbol": "AVGO",
                    "strategy_id": "avgo_bull_strategy",
                    "source_strategy_id": "avgo_bull_strategy",
            ...
            "top_candidates": [
                {
                    "candidate_variant_id": "choppy_top",
                    "base_candidate_variant_id": "choppy_base",
                    "symbol": "AVGO",
                    "strategy_id": "avgo_choppy_strategy",
                    "source_strategy_id": "avgo_choppy_strategy",
                    "family": "single_leg_repair",
                    "intended_regime": "choppy",
                    "parameter_set": '{"hard_exit_minute":35}',
                    "directional_option_type": "call",
                    "research_score": 10_000.0,
                    "min_net_pnl": 3_000.0,
                    "min_test_net_pnl": 1_000.0,
                    "min_fill_coverage": 0.92,
                    "min_option_trade_count": 100,
                    "worst_drawdown": -100.0,
                    "promotion_status": "eligible_for_promotion_review",
                    "promotion_blockers": [],
                }
    ...
    review_ids = [row["candidate_variant_id"] for row in packet["review_candidates"]]
    assert review_ids[:2] == ["bull_rep", "choppy_top"]
    assert packet["eligible_regime_representatives"][0]["candidate_variant_id"] == "bull_rep"
    assert packet["gate_summary"]["unique_eligible_base_candidate_count"] == 2
